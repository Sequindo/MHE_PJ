...
int main(int argc, char **argv)
{
    if(argc>1)
    {
        ...
        Meta::bruteForceMethod<std::chrono::seconds>(problemGraphShort, "graphviz_output_short_bruteforce.txt");
        Meta::hillClimb<std::chrono::nanoseconds>(problemGraphShort, "graphviz_output_short_hillclimb_classic.txt", 10000);
        Meta::hillClimb<std::chrono::nanoseconds>(problemGraphShort, "graphviz_output_short_hillclimb_randomized.txt", 10000, true, 30);
    }
    return 0;
}